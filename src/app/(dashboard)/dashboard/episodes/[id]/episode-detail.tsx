...
export function EpisodeDetail({ episode }: { episode: EpisodeType }) {
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <h1 className="text-2xl font-bold tracking-tight">{episode.name}</h1>
      ...
      <div>
        <h2 className="mb-3 text-lg font-semibold">Characters Appearances ({episode.characters.length})</h2>
        {charsLoading ? (
